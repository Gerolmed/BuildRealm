...
public class SQLLiteGroupRepository extends SQLGroupRepository{
    private final String dbname ="groups";
    private final File parent;

    public SQLLiteGroupRepository(File parent, Logger logger){
        super(logger);
        this.parent = parent;
        load();
    }
